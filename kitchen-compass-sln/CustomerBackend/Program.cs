...
var base64 = Environment.GetEnvironmentVariable("FIREBASE_CREDENTIALS_64");

if (string.IsNullOrEmpty(base64)) {
    throw new InvalidOperationException("Missing FIREBASE_CREDENTIALS_64 environment variable");
}
